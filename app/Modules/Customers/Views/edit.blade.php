                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text">
                            <i class="la la-pencil"></i> {{$customer->name}}
                        </h3>
                    </div>
                </div>
            </div>
                ...
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">
                        <div class="col-lg-6">
                            ...
                            <input name="name" type="text" value="{{$customer->name}}" class="form-control m-input" id="name" placeholder="" required>
                        </div>
                        <div class="col-lg-6">
                            <label>
                                Email
                            </label>
                            <input name="email" type="text" value="{{$customer->email}}" class="form-control m-input" id="email" placeholder="">
                        </div>
                    </div>
                    <div class="form-group m-form__group row">
                        <div class="col-lg-4">
                            ...
                            <input name="phone" type="text" value="{{$customer->phone}}" class="form-control m-input mask-phone" id="phone" placeholder="">
                        </div>
                        <div class="col-lg-4">
                            <label>
                                Celular

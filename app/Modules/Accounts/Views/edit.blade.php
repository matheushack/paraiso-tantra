                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text">
                            <i class="la la-pencil"></i> {{$account->name}}
                        </h3>
                    </div>
                </div>
            </div>
                ...
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">
                        <div class="col-lg-9">
                            ...
                            <input name="name" type="text" class="form-control m-input" id="name" placeholder="" required value="{{$account->name}}">
                        </div>
                        <div class="col-lg-3">
                            <label>
                                Tipo
                            ...
                            <div class="m-radio-inline">
                                <label class="m-radio">
                                    <input type="radio" name="type" value="{{\App\Modules\Accounts\Constants\Types::INTERNAL}}" {{$account->type == \App\Modules\Accounts\Constants\Types::INTERNAL ? 'checked="checked"' : ''}}> Interna
                                    <span></span>
                                </label>
                                <label class="m-radio">
                                    <input type="radio" name="type" value="{{\App\Modules\Accounts\Constants\Types::BANK}}" {{$account->type == \App\Modules\Accounts\Constants\Types::BANK ? 'checked="checked"' : ''}}> Banco
                                    <span></span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div id="box-type-bank" style="{{$account->type == \App\Modules\Accounts\Constants\Types::INTERNAL ? 'display:none;' : ''}}">
                        @component('Accounts::components.bank', ['account' => $account, 'bank_id' => $account->bank_id])
                        @endcomponent
                    </div>
                </div>
